...
public class FavoriteTeamService extends IntentService {
    ...
    public static void startActionUpdateFavoriteTeamWidgets(Context context, Team newFavoriteTeam) {
    ...
    protected void onHandleIntent(Intent intent) {
        if (intent != null) {
            ...
            if (ACTION_UPDATE_FAVORITE_TEAM.equals(action)) {
                ...
                handleActionUpdateFavoriteTeam(team);
            }
        }
    }
     ...
     * parameters.
     */
    private void handleActionUpdateFavoriteTeam(Team newTeam) {
        ...
        FavoriteTeamWidget.updateFavoriteTeamWidgets(this, widgetManager, newTeam, appWidgetIds);
    }
}
